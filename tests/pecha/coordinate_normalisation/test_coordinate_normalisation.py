...
source = {
    "source_pecha_path": DATA_DIR / "IAEB27E9F",
    "source_base_name": "275D"
}
target = {
    "target_pecha_path": DATA_DIR /"IFA46BBC2",
    "target_base_name": "4665"
}
translation = {
    "translation_pecha_path": DATA_DIR / "I6EA29D09",
    "translation_base_name" : "564C"
}
expected_alignment_data = read_json(DATA_DIR / "expected_pecha_display_segment_alignment.json")


def test_coordinate_normalization():
    with patch("openpecha.pecha.coordinate_normalisation.CoordinateNormalisation.update_metadata") as mock_update_metadata:
