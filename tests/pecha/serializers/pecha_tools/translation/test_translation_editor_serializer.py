...
expected_root_translation_serialized_json = read_json("tests/pecha/serializers/pecha_tools/translation/data/serialized_root_translation.json")
expected_commentary_serialized_json = read_json("tests/pecha/serializers/pecha_tools/translation/data/serialized_commentary.json")
...
class TestSerializer(TestCase):
    def setUp(self):
        self.root_display_pecha = Pecha.from_path(
            Path("tests/pecha/serializers/pecha_tools/translation/data/root/bo/IA6E66F92")
        )
        self.root_pecha = Pecha.from_path(
            Path("tests/pecha/serializers/pecha_tools/translation/data/root/bo/IE60BBDE8")
        )
        self.root_translation_pecha = Pecha.from_path(
            Path("tests/pecha/serializers/pecha_tools/translation/data/root/en/I62E00D78")
        )
        self.commentary_pecha = Pecha.from_path(
            Path("tests/pecha/serializers/pecha_tools/translation/data/commentary/bo/I6944984E")
        )
            ...
            "annotations": [
                {
                    ...
                    "annotation_title": "test title",
                    "relationship": (
                        "translation_of", "IE60BBDE8", "3635/Segmentation-039B.json" ),
            ...
            "annotations": [
                {
                    ...
                    "annotation_title": "test title",
                    "relationship": (
                        "commentary_of", "IE60BBDE8", "3635/Segmentation-039B.json" ),
                    "layer_name": "E949/Alignment-2F29.json"
                }
            ],
    ...
    def test_root_pecha(self):
        ...
        assert root_serialized_json["base_text"] == expected_root_serialized_json["base_text"]
        assert root_serialized_json["annotations"] == expected_root_serialized_json["annotations"]
    ...
    def test_root_translation_pecha(self):
        ...
        assert root_translation_serialized_json["base_text"] == expected_root_translation_serialized_json["base_text"]
        assert root_translation_serialized_json["annotations"] == expected_root_translation_serialized_json["annotations"]
    ...
    def test_commentary_pecha(self):
        ...
        serializer = Serializer()
        commentary_serialized_json = serializer.serialize(pechas, metadatas, pecha_category, editor_type, layer_name)
        assert commentary_serialized_json["base_text"] == expected_commentary_serialized_json["base_text"]
        assert commentary_serialized_json["annotations"] == expected_commentary_serialized_json["annotations"]