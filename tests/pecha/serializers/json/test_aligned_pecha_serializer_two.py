...
class TestAlignedPechaSerializer(TestCase):
    def setUp(self):
        ...
        self.target_opf_path =  Path("tests/pecha/serializers/json/data/j03fF9jp4dqveyIG")
        self.source_opf_path =  Path("tests/pecha/serializers/json/data/315eLL7LxtqaIyfX")
    ...
    def test_translation_alignment_serializer(self):
        ...
        expected_serialized_data = read_json(
            self.DATA_DIR / "translation_alignment_two.json"
        )
