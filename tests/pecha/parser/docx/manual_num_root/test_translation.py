...
from openpecha.pecha.parsers.docx.manual_num_root import GoogleDocTranslationParser
...
def test_bo_google_doc_translation_parser():
    ...
    with tempfile.TemporaryDirectory() as tmpdirname, patch(
        "openpecha.pecha.parsers.docx.manual_num_root.GoogleDocTranslationParser.extract_root_idx"
