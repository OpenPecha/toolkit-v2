...
class TestDocxRootParser(TestCase):
    ...
    def test_bo_google_doc_translation_parser(self):
        ...
        anns, base = self.parser.extract_root_segments_anns(bo_docx_file, metadata)
        ...
        with tempfile.TemporaryDirectory() as tmpdirname, patch(
            "openpecha.pecha.parsers.docx.root.number_list_root.DocxRootParser.extract_root_segments_anns"
    ...
    def test_en_google_doc_translation_parser(self):
        ...
        anns, base = self.parser.extract_root_segments_anns(en_docx_file, metadata)
