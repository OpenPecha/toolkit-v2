...
class TestDocxRootParser(TestCase):
    ...
    def test_bo_google_doc_translation_parser(self):
        ...
        segmentation_coordinates, base = self.parser.get_segmentation_anns(bo_docx_file)
        ...
        with tempfile.TemporaryDirectory() as tmpdirname, patch(
            "openpecha.pecha.parsers.docx.root.DocxRootParser.get_segmentation_anns"
    ...
    def test_en_google_doc_translation_parser(self):
        ...
        segmentation_coordinates, base = self.parser.get_segmentation_anns(en_docx_file)
