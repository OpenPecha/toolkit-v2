...
class TestDocxSimpleCommentaryParser(TestCase):
    def setUp(self):
        ...
        self.expected_anns = [
            {"start": 0, "end": 65, "root_idx_mapping": "1"},
            {"start": 66, "end": 330, "root_idx_mapping": "2"},
            {"start": 331, "end": 758, "root_idx_mapping": "2,3"},
            {"start": 759, "end": 1075, "root_idx_mapping": "3-5"},
            {"start": 1076, "end": 1470, "root_idx_mapping": "2,4-5"},
        ]
    ...
    def test_extract_commentary_segments(self):
        ...
        anns, base = parser.extract_segmentation_coords(self.input)
    ...
    def test_create_pecha(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir, mock.patch(
            "openpecha.pecha.parsers.docx.commentary.simple.DocxSimpleCommentaryParser.extract_segmentation_coords"
